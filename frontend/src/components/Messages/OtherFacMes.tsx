...
import styles from './OtherFacMes.module.css';

interface OtherFacMesProps {
...
const OtherFacMes: React.FC<OtherFacMesProps> = ({
  departmentName,
  demandedTANum,
  course,
  courseId,
  ...
  return (
    <div className={styles.container}>
      <p className={styles.message}>
        ...
        <span className={styles.label}> from other faculties.</span>
      </p>
      <button className={styles.assignButton} onClick={handleAssign}>
        Assign TA From Other Faculty
      </button>
    </div>
  );
};

export default OtherFacMes;