...
import styles from './AssignTAProctor.module.css';
...
const AssignTAProctor: React.FC = () => {
  ...
  const handleAutoAssign = () => {
    ...
    const count = Math.min(leftCount, filtered.length);
    const toAdd = filtered.slice(0, count);
    setAssigned(a => [...a, ...toAdd]);
...
export default AssignTAProctor;