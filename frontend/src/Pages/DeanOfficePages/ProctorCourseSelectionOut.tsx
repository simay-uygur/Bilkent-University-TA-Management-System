...
import styles from './ProctorCourseSelectionOut.module.css';
...
const ProctorCourseSelectionOut: React.FC = () => {
  ...
  const handleAssign = (id: string) => {
    navigate(`/deans-office/proctor-out/${id}`);
  };
  ...
  return (
    <div className={styles.pageWrapper}>
      <div className={styles.headerRow}>
        ...
        <h1 className={styles.title}>Exams Proctor Request Other Faculty</h1>
      </div>
...
export default ProctorCourseSelectionOut;
