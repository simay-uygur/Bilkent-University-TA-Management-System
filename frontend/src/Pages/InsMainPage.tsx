...
import CourseInfoPanel from '../Benim/CourseInfoPanel';
              ...
              <div key={course.id} className={styles.courseCard}>
                ...
                <div className={styles.actions}>
                  <button
                    ...
                    onClick={() => navigate(`/instructor/exam-proctoring/${course.id}`)}
                  >
                    Exam Proctoring
                  </button>
                  <button
                    className={styles.actionButton}
                    onClick={() => navigate(`/instructor/exam-printing/${course.id}`)}
                  >
                    Exam Printing
                  </button>
                  <button
                    className={styles.actionButton}
                    onClick={() => navigate(`/instructor/workload/${course.id}`)}
                  >
                    Manage Workload
                  </button>
                  <button
                    className={styles.actionButton}
                    onClick={() => navigate(`/instructor/courses/${course.id}/tas`)}
                  >
                    Course TA
                  </button>
                  <button
